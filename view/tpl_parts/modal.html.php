<div id="addFastProduct" class="modal">
    <div class="modal__content">
        ...
        <form enctype="multipart/form-data" method="post" class="form">
            ...
            <div class="inner inner--mb-18">
                <div class="form__title text text--size-s">Введите Контактный телефон</div>
            ...
            <div class="inner inner--mb-18">
                <div class="form__title text text--size-s">Выберите категорию товара</div>
                <select class="form__select">
                    <option class="form__option">Выберите категорию</option>
                </select>
            </div>
            <div class="inner inner--mb-18">
                <div class="form__title text text--size-s">Введите название товара</div>
                <input name="form_product" type="text" class="form__input"/>
            </div>
            <div class="inner inner--mb-18">
                <div class="form__title text text--size-s">Введите описание товара</div>
